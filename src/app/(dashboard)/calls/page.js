...
var allCalls = [].concat(
  recentCalls,
  [
    Object.assign({}, recentCalls[0], { id: 'call-6', leadName: 'Anna Foster', date: '2026-03-30T10:00:00Z', duration: 1980, dealValue: 4200, outcome: 'closed', aiScorecard: Object.assign({}, recentCalls[0].aiScorecard, { overallScore: 88 }) }),
    Object.assign({}, recentCalls[1], { id: 'call-7', leadName: 'Robert Hayes', date: '2026-03-30T14:00:00Z', duration: 2100, outcome: 'no-close', aiScorecard: Object.assign({}, recentCalls[1].aiScorecard, { overallScore: 55 }) }),
    Object.assign({}, recentCalls[2], { id: 'call-8', leadName: 'Lisa Park', date: '2026-03-29T11:30:00Z', duration: 1680, outcome: 'no-close', aiScorecard: Object.assign({}, recentCalls[2].aiScorecard, { overallScore: 48 }) }),
    Object.assign({}, recentCalls[3], { id: 'call-9', leadName: 'Chris Evans', date: '2026-03-29T15:00:00Z', duration: 2400, dealValue: 3900, outcome: 'closed', aiScorecard: Object.assign({}, recentCalls[3].aiScorecard, { overallScore: 85 }) }),
    Object.assign({}, recentCalls[4], { id: 'call-10', leadName: 'Emily Watson', date: '2026-03-28T09:00:00Z', duration: 1560, dealValue: 4000, outcome: 'closed', aiScorecard: Object.assign({}, recentCalls[4].aiScorecard, { overallScore: 81 }) }),
    Object.assign({}, recentCalls[0], { id: 'call-11', leadName: 'Tom Brady', date: '2026-03-28T16:00:00Z', duration: 2700, dealValue: 6000, outcome: 'closed', aiScorecard: Object.assign({}, recentCalls[0].aiScorecard, { overallScore: 95 }) }),
  ]
);
...
export default function CallsPage() {
  ...
  var avgScore = Math.round(filtered.reduce(function(s, c) { return s + c.aiScorecard.overallScore; }, 0) / filtered.length);
    ...
    <div className="p-6 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        {[
          ...
          { label: 'Avg AI Score', value: avgScore, color: avgScore >= 70 ? 'metric-positive' : 'text-crm-warning' },
        ].map(function(s, idx) {
          return (
