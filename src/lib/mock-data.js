...
export const teamOverview = {
  ...
  showRate: 76.8, showRateTrend: -1.4,
  pipelineValue: 47600, pipelineValueTrend: 8.2,
  bookedCallsThisWeek: 18, bookedCallsTrend: 3.1,
  avgDaysToClose: 4.2, daysToCloseTrend: -0.8,
  cashPerCallTaken: 1248, cashPerCallTrend: 6.3,
  offerRate: 78.4, offerRateTrend: 1.9,
  oneCallCloseRate: 62.5, oneCallCloseTrend: 4.1,
  refundRate: 4.3, refundRateTrend: -1.2,
  netRevenueRetained30d: 179380, netRetainedTrend: 11.8,
  teamDialTarget: 150, avgDialsPerHour: 8.4, dialsPerHourTrend: 0.6,
};

export const closerPerformances = [
  { closer: closers[0], period: '30d', totalDials: 680, connectRate: 28.4, dialToBookRatio: 12.1, showRate: 78.5, closeRate: 41.2, avgDealValue: 4250, totalRevenue: 59500, revenuePerDial: 87.5, dialsTrend: 5.2, closeRateTrend: 3.8, revenueTrend: 18.4, bookedCallsThisWeek: 5, cashPerCall: 1700, offerRate: 88.2, oneCallCloseRate: 71.4, refundRate: 2.1, dialsPerHour: 9.2, consecutiveDaysOnTarget: 14, aiDiagnostic: 'Top performer this month. Strong discovery process and objection handling. Recommend routing high-value inbound leads to Marcus.', aiSuggestions: ['Route premium leads to this closer', 'Have Marcus lead next team training on discovery framework'] },
  { closer: closers[1], period: '30d', totalDials: 720, connectRate: 31.2, dialToBookRatio: 10.8, showRate: 82.1, closeRate: 37.8, avgDealValue: 3800, totalRevenue: 49400, revenuePerDial: 68.6, dialsTrend: 8.4, closeRateTrend: 1.2, revenueTrend: 9.7, bookedCallsThisWeek: 6, cashPerCall: 1235, offerRate: 82.1, oneCallCloseRate: 58.3, refundRate: 3.8, dialsPerHour: 9.8, consecutiveDaysOnTarget: 11, aiDiagnostic: 'Highest connect rate on the team. Offers being made too early before full pain discovery.', aiSuggestions: ['Extend discovery phase by 2-3 minutes', 'Use more tie-down questions before presenting offer'] },
  { closer: closers[2], period: '30d', totalDials: 540, connectRate: 24.1, dialToBookRatio: 15.3, showRate: 65.2, closeRate: 38.9, avgDealValue: 4100, totalRevenue: 45100, revenuePerDial: 83.5, dialsTrend: -12.5, closeRateTrend: -2.1, revenueTrend: -8.3, bookedCallsThisWeek: 3, cashPerCall: 1366, offerRate: 75.0, oneCallCloseRate: 66.7, refundRate: 5.2, dialsPerHour: 6.4, consecutiveDaysOnTarget: 3, funnelBottleneck: 'Show Rate \u2014 65.2% vs team avg 76.8%', aiDiagnostic: 'Declining dial volume. Show rate at 65.2% is the bottleneck. 3 missing EOD reports this month.', aiSuggestions: ['Audit confirmation sequence', 'Set minimum 30/day dial target', 'Review EOD compliance'] },
  { closer: closers[3], period: '30d', totalDials: 580, connectRate: 22.8, dialToBookRatio: 18.2, showRate: 71.4, closeRate: 24.6, avgDealValue: 3650, totalRevenue: 21900, revenuePerDial: 37.8, dialsTrend: 2.1, closeRateTrend: -5.8, revenueTrend: -14.2, bookedCallsThisWeek: 2, cashPerCall: 730, offerRate: 71.4, oneCallCloseRate: 50.0, refundRate: 8.7, dialsPerHour: 7.6, consecutiveDaysOnTarget: 7, funnelBottleneck: 'Close Rate \u2014 24.6% vs team avg 34.2%', aiDiagnostic: 'Struggling on the close. Talk-to-listen ratio is 62/38. Price objections not reframed effectively.', aiSuggestions: ['Review last 5 lost calls with Marcus', 'Practice price objection reframes', 'Target 45/55 talk ratio'] },
  { closer: closers[4], period: '30d', totalDials: 320, connectRate: 35.6, dialToBookRatio: 8.4, showRate: 88.2, closeRate: 29.4, avgDealValue: 3750, totalRevenue: 11550, revenuePerDial: 36.1, dialsTrend: -1.8, closeRateTrend: 4.2, revenueTrend: 6.1, bookedCallsThisWeek: 2, cashPerCall: 962, offerRate: 80.0, oneCallCloseRate: 55.6, refundRate: 1.4, dialsPerHour: 7.2, consecutiveDaysOnTarget: 9, aiDiagnostic: 'Setting metrics are excellent. Closing improving month-over-month. Strong candidate for full closer role.', aiSuggestions: ['Continue developing closing skills', 'Shadow Marcus on 2 calls this week'] },
];
